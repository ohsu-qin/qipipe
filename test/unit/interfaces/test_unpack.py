...
class TestUnpack:
    ...
    def test_unpack(self):
        ...
        result = unpack.run()
        assert_equals(1, result.outputs.a, "Output field a incorrect: %s" % result.outputs.a)
        assert_equals(2, result.outputs.b, "Output field b incorrect: %s" % result.outputs.b)
