...
def link_dicom_files(collection, *dirs, **opts):
    """
    ...
    patterns, as described in L{link_dicom_files}. The output is the
    ...
    For input DICOM files with directory structure:
        ...
        GroupDicom(subject_dir=BreastChemo4, session_pat='Visit*', dicom_pat='*concat*/*', dest=data).run()
    ...
    """
    return DICOMFileGrouper(collection, **opts).link_dicom_files(*dirs)
